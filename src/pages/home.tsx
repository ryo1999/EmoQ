                ...
                <Card sx={{ width: "100%", maxWidth: "800px", mt: "10px" }}>
                    ...
                    <CardContent>
                        <Typography variant="body2">
                            well meaning and kindlywell meaning and kindlywell meaning and kindlywell meaning and
                            kindlywell meaning and kindlywell meaning and kindlywell meaning and kindlywell meaning and
                            kindly
                        </Typography>
                    </CardContent>
                    <CardActions sx={{ justifyContent: "right" }}>
                        <IconButton onClick={() => setBookMark(!bookMark)}>
                            {bookMark ? (
                                ...
                                <BookmarkBorderIcon sx={{ color: "blue" }} />
                            )}
                        </IconButton>
